...
import { X, Search, FileText, Download, Plus, Trash2, Eye } from 'lucide-react';
...
export const SOCManagerModal = ({ deal, client, onClose }: Props) => {
  ...
  // Live update preview when amounts change 
  // (debouncing in real app, but here we can just update when explicitly asked or every time if fast enough)
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-[95vw] h-[95vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-hidden flex bg-slate-50">
          ...
          <div className="w-1/2 h-full overflow-y-auto p-6 border-r border-slate-200">
          ...
          <div className="w-1/2 h-full bg-slate-200 flex flex-col pt-4">
            ...
            <div className="flex-1 w-full relative drop-shadow-md p-4 pt-0">
               {previewUrl ? (
                 <iframe 
                   src={previewUrl} 
                 ...
                 <div className="w-full h-full flex items-center justify-center text-slate-400 bg-white rounded border border-slate-300 text-sm">
                   Generating preview...
                 </div>
               )}
            </div>
